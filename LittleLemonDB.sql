...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `EmployeeID_fk` FOREIGN KEY (`EmployeeID`) REFERENCES `employees` (`EmployeesID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2023-04-23 12:18:16
